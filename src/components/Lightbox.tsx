  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {/* Image Viewer */}
        <div className="absolute inset-0 flex items-center justify-center p-6 md:p-12" onClick={(e) => e.stopPropagation()}>
          <div className="w-full h-full max-w-[90vw] max-h-[75vh] flex items-center justify-center">
            <QuickPinchZoom 
              onUpdate={onUpdate} 
              wheelScaleFactor={0.005} 
              containerProps={{ className: 'w-full h-full flex items-center justify-center overflow-visible' }}
            >
              <div className="flex items-center justify-center w-full h-full">
                <img
                  ...
                  className="max-w-full max-h-full object-contain select-none shadow-[0_30px_60px_-15px_rgba(0,0,0,0.7)] rounded-lg"
